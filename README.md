...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-wordpress-migration-api?sort=semver)](https://github.com/liberusoftware/module-cms-wordpress-migration-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-wordpress-migration-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-wordpress-migration-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-wordpress-migration-api
```
...
<a href="https://github.com/liberusoftware/module-cms-wordpress-migration-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-wordpress-migration-api" alt="Contributors to liberusoftware/module-cms-wordpress-migration-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-wordpress-migration-api/graphs/contributors).
